...
export declare const DEMAND_CATEGORIES: {
    readonly service: readonly ["Elétrica", "Hidráulica", "Chaveiro", "Limpeza", "Montagem", "Pintura", "Construção", "Outros"];
    readonly purchase: readonly ["Mercado", "Padaria", "Farmácia", "Restaurante", "Outros"];
    readonly delivery: readonly ["Documentos", "Pequenos volumes", "Comida", "Compras", "Outros"];
