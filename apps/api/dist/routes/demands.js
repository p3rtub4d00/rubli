...
const demandTypes = ['service', 'purchase', 'delivery', 'freight'];
export async function registerDemandRoutes(app) {
    app.get('/api/v1/demands', async () => memoryStore.demands);
    app.post('/api/v1/demands', async (request, reply) => {
        ...
        const allowedCategories = DEMAND_CATEGORIES[body.type];
