...
async function readProfiles(): Promise<StoredProfiles> { const raw = await AsyncStorage.getItem(PROFILE_KEY); if (!raw) return []; try { return JSON.parse(raw) as StoredProfiles; } catch { return []; } }
...
export default function TestHarness() {
  ...
  async function resetTestData() {
    Alert.alert('Resetar perfis de teste', 'Isso remove somente a lista de perfis para troca rápida. Demandas, propostas, mensagens, avaliações e histórico serão preservados.', [
